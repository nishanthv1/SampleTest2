...
//   }
           ...
           stage('ZAP'){
             steps{
             sh 'docker run -v /var/lib/jenkins/workspace/SampleTest2:/zap/wrk/:rw owasp/zap2docker-stable zap-full-scan.py -m 1 -t https://juice-shop.herokuapp.com/#/ -r test1.html'
             }
         }
         stage('Trivy'){
             steps{
